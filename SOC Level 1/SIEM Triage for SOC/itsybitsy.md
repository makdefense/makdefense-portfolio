...
question i had to figure out how many events were returned for the month of March 2022. I first launched elastic, then inputted the query:
"index=connection_logs," which then returned a total of 1482 events for March 2022.
>
...
> I then discovered 192.166.65.54 as the Ip address associated with the suspected user in the logs by navigating to the left of the application, and hovering over "source_ip."
>
> <img width="627" height="690" alt="3" src="https://github.com/user-attachments/assets/2c3ecd4b-dc8f-43f8-a823-46353206b7ea" />

> I then identified "bitsadmin" as the legit windows binary used to download a file from the C2 server.
>
> <img width="849" height="609" alt="4" src="https://github.com/user-attachments/assets/3aae142b-2fee-4359-a4f6-0bf9b0dcde9c" />

> Moving on to the next question i retrieved the filesharing site:
pastebin.com
in which the infected machine connected with within this period which also acted as a C2 server used by the malware authors to communicate.
>
> <img width="1144" height="223" alt="5" src="https://github.com/user-attachments/assets/45a3e8c5-b8c3-4990-bd88-ef98c3341dc6" />

> The full URL of the C2 to which the infected host is connected is "pastebin.com/yTg0Ah6a."
>
> <img width="781" height="422" alt="6" src="https://github.com/user-attachments/assets/93bede44-2e72-4e9f-ad8f-955ccedf55c9" />

> I then navigated to the full URL of the C2 to find out the file that was accessed on the file sharing site to be "secret.txt."
>
...
> Finally the secret code the file contained was "THM{SECRET__CODE}."
>
