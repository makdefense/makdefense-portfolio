...
> In this lab, I learned how to identify tactics, techniques, and procedures that were being used by a threat group based on a given report.
...
> For this room, i had to again play the role of a CTI analyst, then identify the Tactics, Techniquees, and Procedures (TTP) being used by threat group "APT X," while also gathering information about
their identity and motive. I first read the rport based on "APT X," then was given my first question which was to figure out what kind of phishing campaign does "APT X" use as a part of their TTPs. To
...
> Moving on to the second question i had to figure out the name of the malware used by "APT X." To figure this out i went back to the given report and discovered that it was "USBferry."
>
> <img width="452" height="231" alt="trp2" src="https://github.com/user-attachments/assets/ba7b0623-d741-475a-a14f-b4f9cba57efb" />

> Moving on to the thrid question i had to figure out the STIX ID for the malware "USBFerry." To figure this out i launched OpenCTI using the webiste "http://MACHINE_IP:8080," logged in using the given
...
> Moving on to the fourth question, i had to figure out which technique did "APT X" use for intial access. To figure this out i simply navigated to the top of the OpenCTI application, selected the
...
> Moving on to the fifth question, i had to unravel the identity of "APT X." To figure this out i went back to the given report, clicked the "APT X" linked the was highlighted in blue, and landed on
...
> For the seventh question, i had to figure out the tool linked to APT "Tropic Trooper." To figure this out i navigated to the left of the OpenCTI application, selected "Tools" under the "Arsenal" section,
and discovered that the name of the tool linked was "BITSAdmin."
>
...
> For the eight question, i had to figure out the sub-technique used by the APT under main technique Valid Accounts. To figure this out i simply loaded up the MITRE ATT&CK navigator using the link
...
> Moving on to the second to last question, i had to figure out under what Tactics does the sub-techniques "Local Accounts" fall. To figure this out i navigated to Google Chrome on my system, typed in
...
> Finally, for the last question i had to i had to figure out what technique "Tropic Trooper" is known for using under the tactic Collection. To figure this out i navigated back to the MITRE ATT&CK
navigator webiste on the THM Mozilla Fire, navigated to "Collection," and discovered that the technique "Automated Collection" was highlighted.
>
...
> This lab provided me with knowledge about using cyber threat intelligence knowledge and skills to identify a threat based on a given report.
