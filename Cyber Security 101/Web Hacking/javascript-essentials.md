...
> For the next exercise, I had to get Google Chrome to display the confirmation dialogue "Do you want to proceed?" To do this, I entered the code "confirm("Do you want to proceed?")" and then pressed "enter."
