...
> I then was given a practical to find the 20th password within a file called "rockyou.txt." To do this i inputted the command "head -n 20 rockyou.txt," then pressed "enter" button. This then displayed
the 20th password to be "qwerty."
...
> Next i was given a practical to crack the hash of "5b31f93c09ad1d065c0491b764d04933" using an online tool, to do this i used "hashess.com," and just enter the "5b31f93c09ad1d065c0491b764d04933" hash into
the input field, and the hash that wa given was "tryhackme."
...
then pressed "enter," and was given "spaceman" as the cracked hash value.
